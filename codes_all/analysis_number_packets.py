...
def get_number_packets_data(data_dict):
	final_list = []
	std_dev_list = []
...
with open('ip_data/firefox_fiber_direction.pkl', 'rb') as file:
    fiber_firefox_dict = pickle.load(file)

print("fiber_firefox")
get_number_packets_data(fiber_firefox_dict)

with open('ip_data/firefox_satlink_direction.pkl', 'rb') as file:
    sat_firefox_dict = pickle.load(file)

print("satlink_firefox")
get_number_packets_data(sat_firefox_dict)

with open('ip_data/tor_fiber_direction.pkl', 'rb') as file:
    fiber_tor_dict = pickle.load(file)

print("fiber_tor")
get_number_packets_data(fiber_tor_dict)

with open('ip_data/tor_satlink_direction.pkl', 'rb') as file:
    sat_tor_dict = pickle.load(file)

print("satlink_tor")
get_number_packets_data(sat_tor_dict)
