...
def attack(X_train, y_train, X_valid, y_valid, X_test, y_test, num_classes, len_inp, VERBOSE=1):
    ...
    # Train the model
    # # # # # # # # 
    filepath = 'model_' + arg_2_list[0] + '_' + arg_2_list[1] + '.h5'
...
def main():
    ...
    x = np.load('X_' + arg_2_list[0] + '_' + arg_2_list[1] + '.npy')
    y = np.load('Y_' + arg_2_list[0] + '_' + arg_2_list[1] + '.npy')
